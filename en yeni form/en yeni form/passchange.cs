...
namespace en_yeni_form
{
    public partial class passchange : Form
    {
        ...
        private void buttDegis_Click_1(object sender, EventArgs e)
        {
            if (guessWhat.Text == sonuc.ToString())//captcha dogru mu
            {
                ...
                {
                    mesajreturn.Text = "Yeni Şifre Tekrarıya Eşleşmiyor"; randomcreaotor();
                }
            }
            else
            {
                mesajreturn.Text = "Toplama İşlemi Yanlış Yaptınız"; randomcreaotor();
            }
        }
    }
}
